...
Page({
  ...
  onShareAppMessage: function() {
    ...
    console.log('分享地址：' + '/pages/index/index?goodId=' + this.data.id + '&shareUserId=' + shareUserId +'&storeID='+storeID+'&storeName='+storeName);
    return {
      title: that.data.goods.name,
      desc: '好货分享',
      path: '/pages/goods/goods?goodId=' + this.data.id + '&shareUserId=' + shareUserId +'&storeID='+storeID+'&storeName='+storeName
    }
  },
