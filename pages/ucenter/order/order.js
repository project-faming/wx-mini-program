...
Page({
  ...
  refundOrder: function (e) {
    let that = this;
    let orderId = e.currentTarget.dataset.index;
    wx.navigateTo({ url: '/pages/ucenter/orderRefund/orderRefund?id=' + orderId });
    /*
    wx.showModal({
      title: '',
      content: '确定要取消此订单？',
  ...
  toRefundDetailPage: function (e){
    ...
    wx.navigateTo({ url: '../refundDetail/refundDetail?id=' + refundId });
  },
  ...
  toCommentPostPage: function (e) {
    ...
    wx.navigateTo({ url: '../../commentPost/commentPost?orderId=' + orderId + '&valueId=' + goodsId +'&type=0'});
  },  
  onReady: function() {
    // 页面渲染完成
  },
  ...
  giftSend: function(e) { //赠送分享
    let orderId = e.currentTarget.dataset.index;
    wx.navigateTo({ url: '/pages/ucenter/fetchOrderDetail/fetchOrderDetail?id=' + orderId });
  }
})